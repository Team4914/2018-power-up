...
public class Drivetrain extends Subsystem {
     ...
     * 
     * @param leftSpeed value to set left speed controllers, from 1 to -1
     * @param rightSpeed value to set right speed controllers, from 1 to -1
     */
    public void tankDrive(double leftSpeed, double rightSpeed) {
    	
    	// safety for left side
    	if (leftSpeed < -1) {
    		leftSpeed = -1;
    	} else if (leftSpeed > 1) {
    		leftSpeed = 1;
