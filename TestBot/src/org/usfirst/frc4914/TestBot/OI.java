...
import org.usfirst.frc4914.TestBot.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        rBumper = new JoystickButton(joystick1, 6);
        lBumper = new JoystickButton(joystick1, 5);
        
        rBumper.whenPressed(new AutonomousCommand());
        lBumper.whenPressed(new AutonomousCommand());
    }
